        ...
        if BBGT.size > 0:
            ...
            def calcoverlaps(BBGT_keep, bb):
                ...
                for index, GT in enumerate(BBGT_keep):
                    ...
                    bb_pred_shapely = Polygon([(bb[0], bb[1]), (bb[2], bb[3]), (bb[4], bb[5]), (bb[6], bb[7])])
                    gt_shapely = Polygon([(GT[0], GT[1]), (GT[2], GT[3]), (GT[4], GT[5]), (GT[6], GT[7])])
...
def dota_mAP(detpath, annopath, imagesetfile, classnames, use_07_metric=True):
    ...
    summary_string += f"mAP (VOC, 11-point interpolation: {use_07_metric}): {map}"
