...
class Exp(rumex_leaf_exp):
    def __init__(self):
        ...
        self.gpus = [0]
        self.data_folder = "data/processed/RumexLeaves/RoboRumex"
        self.output_dir = "log/final_model"
        self.eval_interval = 50
        self.save_interval = 50
        self.print_interval = 16
        self.debug = True
        self.ckpt = "models/final_model.pth"
        ...
        self.batch_size = 32  # == number of training images, increase when we have more images.
        self.lr = 0.0005
        self.norm_target = True
        self.weight_decay = 5e-5
        self.num_iterations = 96000
